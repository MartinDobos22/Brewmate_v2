...
import { CONVERSION_PRECISION_ICONS } from '../../constants';
import {
 ...
 *
 * The mark and the tone carry the same information as the word, because a
 * list where everything is grey is a list nobody reads twice: what came
 * across exactly is quiet, what was estimated is marked, and what nobody knew
 * is marked hardest.
 */
...
const PRECISION_ICON_COLORS: Record<ConversionNote['precision'], keyof ColorPalette> = {
  [CONVERSION_PRECISIONS.exact]: 'secondary',
  [CONVERSION_PRECISIONS.estimated]: 'tertiary',
  [CONVERSION_PRECISIONS.unknown]: 'tertiary',
};
    ...
    <View style={styles.note}>
      <View style={styles.noteHeading}>
        <MaterialCommunityIcons
          name={CONVERSION_PRECISION_ICONS[note.precision]}
          size={theme.size.iconTiny}
          color={theme.colors[PRECISION_ICON_COLORS[note.precision]]}
        />
