...
export const envSchema = z
  .object({
    NODE_ENV: z.enum(NODE_ENVIRONMENTS).default(NODE_ENVIRONMENTS.development),
    ...
    DATABASE_POOL_MAX: z.coerce.number().int().positive().default(DEFAULT_POOL_MAX_CONNECTIONS),
