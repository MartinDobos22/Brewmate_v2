 ...
 * label, writing a shop verdict, writing a recipe, answering what somebody
 * said about a cup, reading and converting somebody else's recipe and dialling
 * an espresso in are all cases where being wrong costs a bag of coffee or a
 * morning, and where the answer is an argument rather than a transcription.
 * They go to Sonnet.
 *
