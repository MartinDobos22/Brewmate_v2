...
export const buildApp = async (dependencies: AppDependencies): Promise<FastifyInstance> => {
  ...
  await app.register(bagRatingRoutes, { bagRatingService: services.bagRatingService });
  ...
  await app.register(aiRoutes, {
    ...
    recipeConversionService: services.recipeConversionService,
    espressoDialInService: services.espressoDialInService,
  });
